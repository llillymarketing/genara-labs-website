...
import { Mail, Lock, LogIn, Loader2, ArrowLeft, Check } from "lucide-react";
          ...
          <FadeIn>
            ...
            <p className="text-white/40 max-w-lg mx-auto font-light">
              {showForgotPassword
                ...
                : "Access your Genara Labs account to view orders, track shipments, and manage your research purchases."}
            </p>
          </FadeIn>
        </div>
      </section>
                ...
                resetSent ? (
                  <div className="text-center py-4">
                    ...
                    <p className="text-steel text-sm mb-6">
                      We sent a password reset link to <span className="font-medium text-graphite">{resetEmail}</span>. Check your inbox and follow the instructions.
                    </p>
                    <button
                      onClick={() => {
